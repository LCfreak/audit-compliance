...
### 3. Download the LLM
Download a quantized GGUF model (e.g., `qwen2.5-0.5B-instruct-q4_k_m.gguf`) from Hugging Face and place it in the `backend/models/` directory. Update the `MODEL_PATH` variable in `backend/main.py` if your filename differs.
